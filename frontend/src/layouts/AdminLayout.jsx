...
function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-100 dark:bg-slate-950 font-sans transition-colors duration-200">
      {/* Mobile Top Navbar */}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="hidden lg:flex h-16 items-center justify-between border-b border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 px-8 shadow-xs transition-colors">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={toggleTheme}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors cursor-pointer"
