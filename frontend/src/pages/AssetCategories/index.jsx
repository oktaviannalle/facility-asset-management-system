  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="font-display text-2xl font-bold text-slate-900 dark:text-white">Kategori Aset</h1>
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Kelola master kategori untuk klasifikasi barang dan aset</p>
        </div>
      ...
      <Card className="overflow-hidden">
        {loading ? (
          <div className="p-8 text-center text-sm text-slate-500 dark:text-slate-400">Memuat data kategori...</div>
        ) : categories.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Tambahkan kategori pertama untuk mulai mengelompokkan aset</p>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {categories.map((category) => (
                  <tr key={category.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/60 transition-colors">
                    <td className="px-6 py-4 font-semibold text-slate-900 dark:text-white">{category.name}</td>
                    <td className="px-6 py-4 text-slate-600 dark:text-slate-300 max-w-md">{category.description || '-'}</td>
